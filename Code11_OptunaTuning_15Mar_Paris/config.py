...
TRAINING_CONFIG = {
    ...
    'learning_rate': 5.225e-05,  # Updated from OPTUNA study (Trial 5)
    'weight_decay': 4.696e-04,  # Updated from OPTUNA study (Trial 5)
    'num_workers': 2,
    'pin_memory': True,
    'random_state': 42,
    'class_weights': [2.136586, 1.0],  # Updated from OPTUNA study (Trial 5)
    'patch_proj_dropout': 0.511010,  # Updated from OPTUNA study (Trial 5)
    'classifier_dropout': 0.198204,  # Updated from OPTUNA study (Trial 5)
    ...
    'patch_entropy_lambda': 9.976e-04,  # Updated from OPTUNA study (Trial 5)
